 ...
 * implementation. Body of constructorTest causes tests to use a hash table of
 * length 1 bucket, forcing tests of more than one pair per bucket.
 *
...
public class Map4GradeOther {
    ...
    private Map<String, String> constructorTest() {
        return new Map4<String, String>(1);
    }
     ...
     * @updates map
     * @requires <pre>
     * {@code map = {} and [args.length is even and all keys must be distinct]}
     * </pre>
     * @ensures <pre>
